...
export default function QCHPVoucher() {
  ...
  const features = [
    {
      ...
      description: "Exclusive QCHP exam voucher pricing not available through regular channels",
      color: "text-green-400"
    },
    {
      icon: FiClock,
      title: "Flexible Scheduling",
      description: "Choose from multiple QCHP exam time slots that fit your schedule",
      color: "text-blue-400"
    },
    {
      icon: FiUsers,
      title: "Limited Availability",
      description: "Each QCHP voucher slot has limited capacity ensuring personalized service",
      color: "text-purple-400"
    },
    {
      icon: FiShield,
      title: "Secure & Reliable",
      description: "Your QCHP voucher is guaranteed and backed by our service",
      color: "text-red-400"
    },
    {
      icon: FiGift,
      title: "Instant Delivery",
      description: "Receive your QCHP voucher code immediately after payment",
      color: "text-orange-400"
    },
    {
      icon: FiCalendar,
      title: "Easy Booking",
      description: "Simple calendar-based QCHP exam slot selection process",
      color: "text-cyan-400"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Buy QCHP Prometric Vouchers - Up to 50% Discount | Qatar Council for Healthcare | Hiaraise</title>
        <meta name="description" content="Buy QCHP Prometric voucher at lowest price! Save 50% on Qatar Council for Healthcare Prometric exam fees. Perfect for yourself, family, friends, or clients. Resell Prometric vouchers to earn money while helping others save on exam costs. Buy low, sell high!" />
        ...
        <meta name="twitter:description" content="Get exclusive QCHP license exam vouchers with up to 50% discount. Secure your Qatar Council for Healthcare exam slot." />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "offers": {
            ...
            "description": "Discounted QCHP exam vouchers with up to 50% savings"
          },
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 backdrop-blur-xl border-b border-white/10">
          <div className="max-w-6xl mx-auto px-4 py-16">
            <div className="text-center">
              ...
              >
                Secure your Qatar Council for Healthcare exam slot with exclusive discount vouchers. 
                Up to 50% savings on QCHP license examinations with flexible scheduling and instant delivery.
              </motion.p>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 p-8">
            {activeTab === 'overview' && (
              <div>
                <h2 className="text-3xl font-bold text-white mb-6 text-center">QCHP License Exam Overview</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-4">About QCHP License</h3>
                    <p className="text-gray-300 mb-4">
                      The Qatar Council for Healthcare (QCHP) license is required for all healthcare professionals 
                      practicing in Qatar. Our exclusive vouchers provide significant savings on the 
                      examination fees.
                    </p>
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-start">
                        <FiCheck className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" />
                        Valid for all QCHP license examinations
                      </li>
                      <li className="flex items-start">
                        <FiCheck className="w-5 h-5 text-green-400 mr-2 mt-0.5 flex-shrink-0" />
            ...
            {activeTab === 'pricing' && (
              <div>
                <h2 className="text-3xl font-bold text-white mb-6 text-center">QCHP Voucher Pricing</h2>
                  ...
                  {pricing.map((item, index) => (
                    <div key={index} className="bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-400/30 rounded-xl p-6">
                      <div className="text-center">
                        ...
                        >
                          Buy QCHP Voucher - Save ${item.savings}
                        </Link>
                      </div>
                    </div>
                  ))}
            ...
            {activeTab === 'benefits' && (
              <div>
                <h2 className="text-3xl font-bold text-white mb-6 text-center">Why Choose Our QCHP Vouchers?</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {activeTab === 'faq' && (
              <div>
                <h2 className="text-3xl font-bold text-white mb-6 text-center">QCHP Voucher FAQ</h2>
                <div className="space-y-6">
                  <div className="bg-white/5 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-3">How long is the QCHP voucher valid?</h3>
                    <p className="text-gray-300">QCHP vouchers remain valid until the associated exam slot expires, providing lifetime validity within the slot period.</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-3">Can I transfer my QCHP voucher to someone else?</h3>
                    <p className="text-gray-300">Yes, QCHP vouchers are fully transferable. You can sell or gift your voucher to any eligible candidate.</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-3">What if I can't attend my scheduled QCHP exam?</h3>
                    <p className="text-gray-300">QCHP vouchers are non-refundable, but you can transfer them to another person or use them for a different exam slot if available.</p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-white mb-3">How do I use my QCHP voucher?</h3>
                    <p className="text-gray-300">Present your voucher code during QCHP exam registration. The voucher will cover the examination fees.</p>
                  </div>
                </div>
              </div>
            )}
