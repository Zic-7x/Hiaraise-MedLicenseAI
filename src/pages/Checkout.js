    ...
    if (voucherSlot) {
      ...
      try {
        ...
        const voucherData = {
          ...
          user_id: user.id,
          payment_id: payment.id,
          voucher_code: null, // Will be generated by trigger
        ...
        <AnimatePresence>
          {message && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="mb-6 bg-gradient-to-r from-green-500 to-emerald-600 text-white p-4 rounded-xl shadow-lg border border-green-400/30"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
